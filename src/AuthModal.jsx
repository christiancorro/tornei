    ...
    >
      <div className="bg-white rounded-2xl w-full max-w-sm p-6" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="text-sm text-gray-500 mb-5">
          Ti serve per scrivere in bacheca, rispondere agli annunci e proporre
          un torneo. Nessuna password da ricordare.
        </p>
        ...
        <button
          type="button"
          onClick={onClose}
          className="w-full mt-4 py-2 text-sm font-bold underline"
          style={{ color: GRASS_DARK }}
        >
